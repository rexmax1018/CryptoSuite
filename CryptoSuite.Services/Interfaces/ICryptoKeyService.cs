...
namespace CryptoSuite.Services.Interfaces
{
    /// <summary>
    ...
    public interface ICryptoKeyService
    {
        ...
        Task<KeyGenerationResult> GenerateAndSaveKeyAsync<TModel>(CryptoAlgorithmType algorithm, string? filePath = null) where TModel : class;
        ...
        Task<TModel> LoadFromFileAsync<TModel>(CryptoAlgorithmType algorithm, string path) where TModel : class;
